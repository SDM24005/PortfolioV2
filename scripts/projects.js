...
const baseProjects = [
    ...
    },
    {
        name: "Progetto 2023",
        page: "../Progetti/biocare/progetto.html",
        preview: "../Progetti Open/biocare/img/reference_1345.png",
...
// Progetti Open con tag lunghi fittizi e anni vari (stessi dati dei progetti normali)
const baseOpenProjects = [
    {
        name: "Biocare",
    ...
    },
    {
        ...
        page: "../Progetti Open/biocare/progetto.html",
        preview: "../Progetti Open/biocare/img/preview.jpg",
        description: "Progetto dell'anno 2017.",
        tags: ["product design", "industrial design", "3D modeling", "rendering", "prototyping"],
        startDate: "2017",
        endDate: "",
        images: []
    },
    {
        ...
        page: "../Progetti Open/biocare/progetto.html",
        preview: "../Progetti Open/biocare/img/preview.jpg",
        description: "Progetto dell'anno 2016.",
        tags: ["fashion design", "textile design", "pattern design", "surface design", "color theory"],
        startDate: "2016",
        endDate: "",
        images: []
    }
...
// Duplica i progetti open per avere più varietà (5 volte = 50 progetti)
const openProjectsTemp = [];
for (let i = 0; i < 5; i++) {
    baseOpenProjects.forEach((project, index) => {
        openProjectsTemp.push({
            ...project,
            name: `${project.name} ${i + 1}`
        });
    });
...
// Mischia anche i progetti open per distribuire casualmente le preview
const openProjects = shuffleArray(openProjectsTemp);
